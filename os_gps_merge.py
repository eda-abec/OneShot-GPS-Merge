...
parser.add_argument(
 #   "-w", "--WiGLE-file",  # will be optional when time matching is implemented
    ...
    type = str,
    default = "WiGLE.csv",
    help = "Input file with APs and their GPS coordinates, generated by Wigle, usually named WigleWifi_{date}.csv. Note: must be latin-1 encoded, which is default"
)
...
WiGLE_file = open(args.WiGLE_file, encoding="latin-1")
